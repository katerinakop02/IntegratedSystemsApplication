...
namespace PetAdoption.Service.Implementation
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(EmailMessage allMails)
        {
            ...
            {
                Sender = new MailboxAddress("PetAdoption Application", "integrated_systems@gmail.com"),
                Subject = allMails.Subject
            };

            emailMessage.From.Add(new MailboxAddress("PetAdoption Application", "integrated_systems@gmail.com"));
