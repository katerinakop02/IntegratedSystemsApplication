...
using PetAdoption.Repository.Implementation;
...
builder.Services.AddDefaultIdentity<Adopter>(options => options.SignIn.RequireConfirmedAccount = true)
    .AddEntityFrameworkStores<ApplicationDbContext>();
builder.Services.AddControllersWithViews();

builder.Services.AddScoped(typeof(IRepository<>), typeof(Repository<>));
builder.Services.AddScoped(typeof(IUserRepository), typeof(UserRepository));
builder.Services.AddScoped(typeof(IAdoptApplicationRepository), typeof(AdoptApplicationRepository));
...
builder.Services.AddTransient<IAdoptApplicationService, AdoptApplicationService>();
